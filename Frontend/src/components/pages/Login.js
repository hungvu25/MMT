    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12 border border-gray-100">
        ...
        <p class="mt-10 text-center text-sm text-slate-500">
          Demo: Use any user ID like <code class="bg-gray-100 px-2 py-1 rounded">user_123</code>
        </p>
      </div>
    </div>
  `;
    ...
    container.querySelector('#userid-container').appendChild(userIdInput);
    ...
    const usernameInput = createInput({
        ...
        icon: `<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" /></svg>`
    });
